...
class SculptureMediaController extends AdminController
{
    /**
    ...
    protected function grid()
    {
            ...
            if (Admin::user()->id != 1) {
               ...
               $scul = Sculpture::where('admin_user_id','=',Admin::user()->id)->pluck('id');
                 $grid->model()
                ->whereIn('sculpture_id',$scul);
            }
    
            $grid->column('image', __('Image'))->image();
            $grid->column('sculpture_id', __('Id de l\'œuvre'))->display(function ($title) {
