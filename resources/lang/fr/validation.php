...
return [
    ...
    */
    ...
    'after_or_equal' => ' :attribute doit être une date après ou égale to :date.',
    ...
    'exists' => ' choisie :attribute est invalide.',
    ...
    'gte' => [
        'numeric' => ' :attribute doit être supérieur à ou égalel :value.',
        'file' => ' :attribute doit être supérieur à ou égalel :value kilobytes.',
        'string' => ' :attribute doit être supérieur à ou égalel :value caractères.',
        'array' => ' :attribute doit avoir :value éléments ou plus.',
    ],
    'image' => ' :attribute doit être une image.',
    'in' => ' choisie :attribute est invalide.',
    ...
    'lt' => [
        ...
        'array' => ' :attribute must have less than :value éléments.',
    ],
    'lte' => [
        'numeric' => ' :attribute doit être inférieur à ou égale :value.',
        'file' => ' :attribute doit être inférieur à ou égale :value kilobytes.',
        'string' => ' :attribute doit être inférieur à ou égale :value caractères.',
    ...
    'not_in' => ' choisie :attribute est invalide.',
    ...
    'required_if' => ' :attribute le champ est obligatoire lorsque :other est :value.',
    'required_unless' => ' :attribute le champ est obligatoire sauf si :other est dans :values.',
    'required_with' => ' :attribute le champ est obligatoire lorsque :values est present.',
    'required_with_all' => ' :attribute le champ est obligatoire lorsque :values sont present.',
    'required_without' => ' :attribute le champ est obligatoire lorsque :values est non present.',
    'required_without_all' => ' :attribute champ est obligatoire lorsqu\'aucun des :values sont present.',
    'prohibited' => ' :attribute champ est interdit.',
    'prohibited_if' => ' :attribute champ est interdit lorsque :other est :value.',
    'prohibited_unless' => ' :attribute champ est interdit à moins que :other est dans :values.',
